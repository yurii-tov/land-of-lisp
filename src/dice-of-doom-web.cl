(load "src/dice-of-doom.cl")
(load "src/svg.cl")
(load "src/webserver.cl")
...
(defun draw-tile-svg
  (x y pos hex xx yy col chosen-tile)
  (loop for z below 2
...
(defun web-handle-computer ()
  (setf *cur-game-tree* (cadr (handle-computer *cur-game-tree*)))
